...
export default function TeamsCarousel() {
  ...
  if (isLoading)
    return (
      <div className="max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-4xl xl:max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="p-5 lg:p-2.5 xl:p-5">
  ...
  return (
    <Carousel
      className="max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-4xl xl:max-w-6xl mx-auto group"
        ...
        {data.map((info: TeamMember, index: number) => (
          ...
          >
            <div className="p-5 lg:p-2.5 xl:p-5">
              <Card className="w-full h-full aspect-square shadow-lg rounded-2xl overflow-hidden dark:bg-dark-card">
                <CardContent className="relative w-full h-full flex flex-col items-center justify-end p-0">
                  ...
                  />
                  <div className="w-full bg-black/30 dark:bg-black/60 backdrop-blur-sm z-50 py-4 space-y-2 rounded-b-md">
